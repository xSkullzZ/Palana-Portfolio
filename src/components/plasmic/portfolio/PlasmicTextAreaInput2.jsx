...
import sty from "./PlasmicTextAreaInput2.module.css"; // plasmic-import: jvhZfPwC9czw/css

createPlasmicElementProxy;

export const PlasmicTextAreaInput2__VariantProps = new Array(
  "type",
  "flat",
  "padded"
);

export const PlasmicTextAreaInput2__ArgProps = new Array(
  "value",
  "placeholder",
  "disabled",
  "readOnly",

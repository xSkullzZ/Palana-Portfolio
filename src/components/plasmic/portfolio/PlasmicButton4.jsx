...
import sty from "./PlasmicButton4.module.css"; // plasmic-import: j_x87glc9dWl/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: _kwRrvpjKPF2/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__zWx5R)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__bdkOh)}
                role={"img"}
              />
            ),

...
import sty from "./PlasmicLabel2.module.css"; // plasmic-import: 1E9avwzW8d2p/css

createPlasmicElementProxy;

export const PlasmicLabel2__VariantProps = new Array(
  "size",
  "requirementIndicator"
);

export const PlasmicLabel2__ArgProps = new Array("children");
